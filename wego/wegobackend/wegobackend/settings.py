"""
Django settings for wegobackend project.
...
print((BASE_DIR / "wego" / "build" / "logo192.png").exists())
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # твой React-фронтенд
]
...
TEMPLATES[0]["DIRS"] = [BASE_DIR / "wego" / "build"]
